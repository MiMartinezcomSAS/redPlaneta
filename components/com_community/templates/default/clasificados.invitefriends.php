...
?>
<div id="community-clasificados-wrap" style="padding-top: 20px;">
	<div id="community-clasificados-news-items" class="app-box" style="width: 70%; float: left;margin-top: 0px;">
		<div class="app-box">
			<div class="app-box-l">
